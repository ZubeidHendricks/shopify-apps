...
Hide a named delivery option (e.g. Express) when the cart subtotal is below a threshold, and (Pro) for specific countries.

Part of the [Shopify app factory](../../README.md). Built from the base template
+ the `delivery-hide` preset, so OAuth, billing, GDPR webhooks, settings, and
