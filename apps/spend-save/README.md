...
Spend-more-save-more: apply a percentage discount once the cart subtotal crosses a threshold. Pro unlocks multiple tiers.

Part of the [Shopify app factory](../../README.md). Built from the base template
+ the `discount-spend` preset, so OAuth, billing, GDPR webhooks, settings, and
