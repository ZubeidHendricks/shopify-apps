...
Reward variety: apply a percentage discount when the cart contains at least N different products. Starter requires 2 distinct items; Pro lets you set the threshold.

Part of the [Shopify app factory](../../README.md). Built from the base template
+ the `bundle` preset, so OAuth, billing, GDPR webhooks, settings, and
